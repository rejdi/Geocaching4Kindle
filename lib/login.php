...
function login($username, $password, $session_id) {
	...
	$command = "wget --post-file='".$postfile."' --keep-session-cookies -e robots=off --save-cookies ".$cookiefile." --referer='https://www.geocaching.com/login/default.aspx' 'https://www.geocaching.com/login/default.aspx' -O /dev/null -o /dev/null";
